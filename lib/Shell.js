...
class Shell {
    ...
    static addDefaultCommand(name, fn) {
        if (typeof name !== "string") throw new TypeError("addDefaultCommand expected 'name' to be a String");
        if (typeof fn !== "function") throw new TypeError("addDefaultCommand expected 'fn' to be a Function");
